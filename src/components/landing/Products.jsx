  ...
  return (
    <section id="products">
      <div>
        {/* Header */}
        <div
          className="text-center mb-16 bg-primary-600 py-24"
          data-aos="fade-up"
        >
          ...
          <p className="text-xl text-white max-w-3xl mx-auto">
            Kami menyediakan berbagai macam produk plastik berkualitas tinggi
            untuk kebutuhan kemasan industri Anda
          </p>
